...
const detailProduct = {
  ...
  name: "Premium Aluminium Frame",
  description: "Lightweight anodized aluminium frame with brushed-copper insert and customizable plate for awards or corporate gifting.",
  price: 1899,
  productCode: "AL FRAME 01",
  minOrderQty: 6,
  images: [
    "/alumnium-frame/frame1.jpg",
    "/alumnium-frame/frame2.jpg",
  ],
};

const whatsappNumber = "9074145962";

const AluminiumFramesShowcase = () => {
  ...
  const productLink = `${origin}/product/${detailProduct.id}`;

  const whatsappMessage = encodeURIComponent(
    `Hello! I am interested in the "${detailProduct.name}" aluminium frame. Product code ${detailProduct.productCode}. ${productLink}`,
  );
  const enquiryMessage = encodeURIComponent(
    `Hello! Please send a quote for "${detailProduct.name}" (${detailProduct.productCode}). ${productLink}`,
  );
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-start">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
              ...
              >
                <img
                  ...
                  className="h-[70vh] w-full object-contain lg:h-[82vh]"
                />
          ...
          <div className="flex w-full flex-col gap-6">
            ...
            <p className="text-xs text-muted-foreground hidden sm:block">
              WhatsApp opens with your enquiry details automatically filled.
            </p>
          </div>
        </div>
        {zoomOpen && (
...
export default AluminiumFramesShowcase;
