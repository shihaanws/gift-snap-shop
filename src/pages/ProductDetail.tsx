...
const ProductDetail = () => {
  ...
  const enquiryUrl = `https://wa.me/9074145962?text=${enquiryMessage}`;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 pb-6 sm:pb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
              ...
              <AnimatePresence mode="wait">
                <motion.img
                  ...
                  ${
                    ...
                    product.category == "desktop-lifetime-calenders" ||
                    product.category == "business-card-holders"
                      ? ""
                      : imageFitClass
                  }`}
                />
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 sm:flex-col sm:items-start">
              ...
              {product.price > 0 && product.gstRate && (
              ...
              <table className="w-full min-w-[320px] text-sm">
                <tbody className="divide-y">
                  ...
                  <tr>
                    ...
                    <td className="py-2">{product.material || "N/A"}</td>
                  </tr>
                  {/* <tr>
                  <td className="py-2 font-medium text-muted-foreground">
                    Master Carton
                  ...
                  <tr>
                    ...
                    <td className="py-2">{product.customized || "N/A"}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-2 hidden sm:flex w-full items-center justify-center gap-3 border border-border px-6 py-3 rounded-xl font-semibold text-foreground"
            >
        ...
        <div className="sticky bottom-0 left-0 right-0 z-40 sm:hidden bg-background border-t border-border px-0 py-3 flex flex-col gap-2">
          <button
            onClick={handleAddToCart}
